...
export const meta = () => {
  return [
    { title: "CVmind | Auth" },
    { name: "description", content: "Login or sign up to access your personalized resume feedback and application tracking." },
  ];
}
...
const Auth = () => {
    ...
    return (
        <main className="bg-[url('/images/bg-main2.png')] bg-cover min-h-screen flex items-center justify-center">
